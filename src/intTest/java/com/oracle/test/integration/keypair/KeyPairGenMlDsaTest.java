...
public class KeyPairGenMlDsaTest {

    private static Stream<Arguments> mlDsaTypes() {
        return Stream.of(
            Arguments.of("ML-DSA", "ML-DSA-65"),
    ...
    public void testFixedSeed(String kpgName, String defaultAlgo) throws Exception {
        ...
        SecureRandom sr = new FixedSizeRand(32);
